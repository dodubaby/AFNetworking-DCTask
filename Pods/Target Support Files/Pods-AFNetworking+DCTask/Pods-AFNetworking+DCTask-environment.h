...
// ConcurrentKit
#define COCOAPODS_POD_AVAILABLE_ConcurrentKit
#define COCOAPODS_VERSION_MAJOR_ConcurrentKit 0
#define COCOAPODS_VERSION_MINOR_ConcurrentKit 1
#define COCOAPODS_VERSION_PATCH_ConcurrentKit 0
